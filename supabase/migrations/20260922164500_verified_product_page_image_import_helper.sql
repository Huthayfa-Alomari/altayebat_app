create or replace function private.import_product_image_page(
  p_store_id uuid,
  p_product_id uuid,
  p_page_url text,
  p_source text default 'manual-web-page',
...
revoke all on function private.import_product_image_page(uuid,uuid,text,text,text)
