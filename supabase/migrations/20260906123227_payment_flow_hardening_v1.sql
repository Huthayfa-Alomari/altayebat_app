...
revoke all on function private.admin_update_store_payment_config_impl(uuid,text,text,text) from public;
...
revoke all on function public.admin_update_store_payment_config(uuid,text,text,text) from public;
grant execute on function public.admin_update_store_payment_config(uuid,text,text,text) to authenticated;
...
revoke all on function private.cancel_unstarted_card_order_impl(uuid) from public;
