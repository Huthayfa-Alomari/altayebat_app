-- Measured/bulk products foundation.
-- Existing checkout contracts remain backward compatible:
--   piece  -> stock_qty is pieces, price is JOD/piece
--   weight -> stock_qty is grams,  price is JOD/gram
--   volume -> stock_qty is ml,     price is JOD/ml
-- price_per_unit stores the human-facing JOD/piece, JOD/kg or JOD/litre price.
