...
class StorePublicSettings {
  ...
  factory StorePublicSettings.defaults() => const StorePublicSettings(
    ...
    whatsappDefaultMessage: 'مرحباً أسواق الطيبات، أحتاج مساعدة بخصوص طلبي.',
  ...
  factory StorePublicSettings.fromMap(Map<String, dynamic> map) {
    ...
    return StorePublicSettings(
      ...
      announcementTitle: text('announcement_title', defaults.announcementTitle),
      ...
      announcementStyle: text('announcement_style', defaults.announcementStyle),
